...
import sorcer.delta.provider.Delta;
import sorcer.delta.provider.ServiceDelta;
...
public class DeltaTest implements SorcerConstants {

	private final static Logger logger = Logger
			.getLogger(DeltaTest.class.getName());
	...
	static {
		...
		Sorcer.setCodeBase(new String[] { "jeri-delta-dl.jar" });
		System.out.println("CLASSPATH :" + System.getProperty("java.class.path"));
		System.setProperty("java.protocol.handler.pkgs", "sorcer.util.url|org.rioproject.url");
	}
	
//	@Test
//	public void deltaCountereTest() throws Exception {
//		Task t1 = task("t1",
